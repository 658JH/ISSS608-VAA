...
ggplot2 annotation with *repel*, *ggrepel* provides *geoms* for ggplot2 to repel overlapping text labels, Text labels repel away from each other, away from data points, and away from edges of the plotting area (panel).
- geom_text_repel()
- geom_label_repel()
